...
// clicking it will redirect the user to the Event page with the event descriptions passed
// down as props
const Feed = () => {
    ...
    return (
        <View>
            // loop through all posts and inject each one into a card component
            <Card>
