		...
		<View style={styles.card}>
			<View style={styles.eventDetails}>
				...
				<View style={styles.eventDate}>
					<Text style={styles.eventDay}>{parseDate(eventDisplaying.startDateTime.toDate()).day}</Text>
					<Text
						style={styles.eventTime}
					>{`${parseDate(eventDisplaying.startDateTime.toDate()).ampmTime} - ${parseDate(eventDisplaying.endDateTime.toDate()).ampmTime}`}</Text>
				</View>
			</View>
			<View style={styles.peopleGoingAndTagsContainer}>
				<View style={styles.peopleGoingContainer}>
					<Text style={styles.peopleGoing}>{eventDisplaying.attendees.length} people going</Text>
				</View>
