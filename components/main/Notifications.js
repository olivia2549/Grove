...
import {Text, View, FlatList, TouchableOpacity, Image, Button, StyleSheet, Platform} from "react-native";
...
export const Notifications = () => {
    ...
    const incomingRequests = useSelector(state => state.currentUser.incomingRequests);
